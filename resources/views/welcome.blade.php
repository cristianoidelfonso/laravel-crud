                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">
                                    <a href="{{ route('products.index') }}" class="underline">Products</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://ideltech.com.br" target="_blank" class="underline">
                                Ideltech
                            </a>


                            <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" class="ml-4 -mt-px w-5 h-5 text-gray-400">
                                <path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            <a href="https://github.com/cristianoidelfonso" target="_blank" class="underline">
                                Github
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        <span class="ml-4">Projeto CRUD | <span>
                        <a href="https://www.techiediaries.com/laravel-8-crud-tutorial/" target="_blank">Referência</a>
                    </div>
                </div>
            </div>
        </div>
